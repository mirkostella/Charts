...
#include "../../Mirko_Stella_Charts/listwidget.h"
...
QT_MOC_LITERAL(1, 11, 17), // "itemDoubleClicked"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 8) // "Grafico*"

    },
    "ListWidget\0itemDoubleClicked\0\0Grafico*"
};
...
void ListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemDoubleClicked((*reinterpret_cast< Grafico*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ListWidget::*)(Grafico * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ListWidget::itemDoubleClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ListWidget::itemDoubleClicked(Grafico * _t1)
{
